package com.example.databasedeptapp;
...
public class CDB extends SQLiteOpenHelper { //CDB is a class for database inherited from SQLiteOpenHelper
    ...
    public void addDept(String dn,String dl){ // user defined method
        try{
    ...
    public String[] getOneDepartment(int dno){ // user defined method
